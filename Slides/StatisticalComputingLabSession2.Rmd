...
|-----------|-----------------|
| Merging datasets and creating state-level counts | Data prep: aggregate ICE arrests by state, merge with governor and population data |
| Visualizing the relationship | Problem 1a: Boxplot of arrests by governor's party |
| Log transformation of a skewed outcome | Problem 3: Create `log_arrests`, re-run models, interpret |
...
| Lab Skill | Homework 2 Task |
|-----------|-----------------|
| Bivariate regression | Problem 1b–e: `lm(arrests ~ repub)`, interpret slope and significance |
| Adding a control variable | Problem 2: Add `Population`, compare coefficients across models |
| Using `modelsummary` | Problems 1–3: Present and interpret regression tables |
| Interpreting confounding | Problem 2c: Assess whether population meets the definition of a confounder |
