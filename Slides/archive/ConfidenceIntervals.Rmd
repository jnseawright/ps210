...
1. Explain the logic of null hypothesis testing using a sampling distribution
2. Interpret a p-value correctly — and describe what it does *not* tell you
3. Distinguish statistical significance from substantive significance
4. Run and interpret a two-sample proportions test in R
5. Explain what an observational study is and identify its key threat to causal inference
