...
1. Explain what regression does and why it is useful when independent variables are quantitative
2. Interpret a regression coefficient in plain language
3. Explain how multiple regression controls for confounding variables
4. Write and run a regression in R and interpret the output
5. Distinguish the slope, intercept, and error term in the regression equation
