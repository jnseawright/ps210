...
student's final grade for the semester (\emph{r} = 0.712) for all 800
...
semester leads to an estimated increase of 0.761 in the student's final
...
means an estimated decrease of 3.805 in the overall grade. The effect of
attendance on the final grade for the class is precise (\emph{t} =
28.682) and the likelihood that there is no actual relationship between
...
well (R\(^2\) = 0.508). See Figure 1 in this document.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figs/attendplot.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figs/calendar.pdf}}
